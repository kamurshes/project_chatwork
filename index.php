...
// ここからデータベース接続をし、テーブルにデータを格納する
	...
	$INSERT=$pdo ->prepare('INSERT INTO users(name, email, tel, scenario, free1) VALUES (:name,:email,:tel,:scenario,:free1)');
	...
	$INSERT->bindParam(':free1',$free1,PDO::PARAM_STR);
